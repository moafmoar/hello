...
#调用 readLines 读取停用词
    stopwords = readLines('E:/workspalce/python/hello/txt/stopwords.txt')
...
def words():
    #情感词
    senList = readLines2('E:/workspalce/python/hello/txt/BosonNLP_sentiment_score.txt')
    senDict = defaultdict()
    for s in senList:
        senDict[s.split(' ')[0]] = s.split(' ')[1]
    #否定词
    notList = readLines2('E:/workspalce/python/hello/txt/否定词.txt')
    #程度副词
    degreeList = readLines2('E:/workspalce/python/hello/txt/degreewords.txt')
