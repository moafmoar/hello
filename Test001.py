...
jieba.load_userdict(
    'E:/workspalce/python/hello/userdic.txt','r')  # Load user dictionary to increse segmentation accuracy
...
def seg_fil_excel(filepath, sheetnum, colnum):
    ...
    review_data = []
    for cell in get_excel_data(filepath, sheetnum, colnum, 'data')[
                0:get_excel_data(filepath, sheetnum, colnum, 'rownum')]:
...
print(get_txt_data(u"E:/workspalce/python/hello/联系.txt","line"))